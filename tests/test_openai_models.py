...
def test_model_router_assigns_gpt_models_to_only_the_three_final_agents():
    ...
    assert router.for_agent("synthesis").model == "gpt-4o-mini"
    assert router.for_agent("validation").model == "gpt-4o-mini"
    assert router.for_agent("report").model == "gpt-4o-mini"
